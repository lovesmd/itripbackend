...
public class MailDemo {
    public static String account = "smd2777467519@163.com";			//替换为发件人账号
    public static String password = "WLOKQRCEUQOBXISX";					//授权码

    public static String receiveMailAccount = "weikuoye@163.com";	//替换为收件人账号
    //CBSLYVLFDSUBQZEE
